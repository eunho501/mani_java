...
// 기본테이터 타입으로 선언한 변수는 데이터 저장이 직접 가능하다 
// int num=0;
...
//		System.out.println();
		...
		//동물 이름은 볼트 렉스 꼬끼오 총총이 
		//나이는 하고싶은나이 아무거나 
		//듕물 한마리에 대해서 데이터입력하고 출력 
		...
		System.out.println("타입:"+dog.type);	
		
	}

}

class Animal{// 동물저장 정보 클래스
String name;//동물이름
int age;//동물나이
String type;//동물종류 
}

//class Member{// 클래스 정의 - 클래스안의 내용으로 데어터 저장될수 있게
//	// 만들겠다고 정의만 한것
//String name; // 이름저장
//int age; // 나이 
//float eyes;//시력저장 
...
//4. 케밥 표기법 
//카멜표기법과 달리 소문자로 표현하며 단어와 단어사이에 -븥이기 
//my-visitor-count
//css의 class명 web url 
