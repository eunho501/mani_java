...
public class Main {
	...
	public static void main(String[] args) {
		...
		//Hashset 직접값 한개씩 출력불가
		//HashSet에 저장되어 있는값 하나씩 출력하는방법 1
		...
		//거래내역 3달치내역을 가져온다
		//만원이하 5만원이하 10만원이하 
		//거래내역을 데이터베이스에서 가져와서 ArrayList 나 vector에저장
		//반복문을 돌리면서 if문사용해서 만원이하인경우 
		//HashSet A에저장 5만원이하는 HashSet B에 저장
		//HashSet c에는 10만원이하 저장 
		...
		차집합2.removeAll(예나과일);//removeAll= 차집
		System.out.println(차집합);
